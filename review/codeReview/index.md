...
## 解决代码冲突
  ...
  如果代码评审中有任何冲突，开发人员和评审人员都应该首先根据[开发者指南](../Owner)和[评审者指南](../Reviewers)中其他文档的内容，尝试达成一致意见。  
...
- **[评审者指南](../Reviewers/index.md)**: 代码评审者的详细指南。
- **[开发者指南](../Developer/index.md)**: 提交变更评审的开发者的详细指南。
